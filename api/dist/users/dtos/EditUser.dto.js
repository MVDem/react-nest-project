...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Token', description: 'Токен ползователя' }),
    (0, class_validator_1.IsString)({ message: 'Должно быть строкой' }),
    __metadata("design:type", String)
], EditUser.prototype, "token", void 0);
__decorate([
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '+79998887766', description: 'Номер телефона' }),
    (0, class_validator_1.IsString)({ message: 'Должно быть строкой' }),
    __metadata("design:type", String)
], EditUser.prototype, "phone", void 0);
__decorate([
    ...
    (0, class_validator_1.IsString)({ message: 'Должно быть строкой' }),
    __metadata("design:type", String)
], EditUser.prototype, "\u0441ompanyName", void 0);
