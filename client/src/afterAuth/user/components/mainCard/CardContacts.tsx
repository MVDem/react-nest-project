  ...
  return (
    <>
      <div className={styles.card}>
        <h3 className={styles.card__title}>Contacts</h3>
        <div className={styles.contacts}>
          <div>
            <p className={styles.contacts__title}>ИП "Иванов Иван Иванович"</p>
            <p className={styles.contacts__title}>phone: 7(999)999-99-99</p>
            <p className={styles.contacts__title}>email: support@mail.ru</p>
            <p className={styles.contacts__title}>telegram: @support</p>
          </div>
